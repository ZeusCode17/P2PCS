...
\begin{itemize}
	...
	\item \textbf{Norme di Progetto}: utilizzando gli strumenti sopra indicati si stende il documento \textit{Norme di progetto v4.0.0} indipendente dal capitolato scelto. Il documento \textit{Norme di Progetto} viene redatto dall'\textit{Amministratore} per conto del \textit{Responsabile di progetto};
	...
	\item \textbf{Analisi dei Requisiti}: questa attività è volta alla produzione del documento \textit{Analisi dei requisiti v4.0.0} relativo al progetto scelto. Questo file è in continua fase di miglioramento fino alla data di consegna;
	\item \textbf{Piano di Progetto}: il \textit{Responsabile} analizza le singole attività e le loro date di scadenza in modo da gestire le risorse necessarie al loro completamento, viene redatto il documento \textit{Piano di progetto v4.0.0};
	\item \textbf{Piano di Qualifica}: attività volta alla redazione del file \textit{Piano di qualifica v4.0.0}, il quale individua le metodologie implicate nel garantire la qualità del prodotto; 
...
\begin{itemize}
	...
	\textit{Piano di Qualifica v4.0.0};
...
\textit{Periodo: dal 2019-06-18 al 2019-07-12 } \\
...
\end{figure}
\subsubsection{Adattamento della pianificazione}
A seguito del consuntivo di periodo riportato nella sezione §6.4 si è resa necessaria una riorganizzazione delle attività e delle risorse. Le ore investite nella progettazione nelle fasi precedenti hanno permesso un aumento delle ore da programmatore, in questo modo si è pottuto soddisfare l'insieme dei requisiti obbligatori richiesti dalla proponente e inoltre abbiamo soddisfatto il 73\% dei requisiti desiderabili e l'80\% dei requisiti facoltativi. In questa fase abbiamo inoltre programmato un incontro con la proponente in modo da poter mostrare il nostro prodotto e ricevere un ultimo feedback prima della definitiva consegna.