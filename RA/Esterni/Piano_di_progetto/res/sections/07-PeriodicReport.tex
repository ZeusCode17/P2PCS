...
\subsubsection{Preventivo a finire}
A seguito di un ottima codifica del prodotto eseguita grazie all'impiego di un monte ore maggiore nelle fasi precedenti, sono stati risparmiati \EUR{805,00} ai quali vengono sottratti gli \EUR{825,00} di debito della precedente fase, per costo totale di \EUR{20,00}. Visto la grande percentuale di requisiti desiderabili e facoltativi implementati e la totalità dei requisiti obbligatori, il gruppo si dichiara soddisfatto del consuntivo a finire. Questo anche a seguito di un incontro con la proponente la quale ha accettato di buon grado l'ultima versione presentata.
