...
\begin{table}[H]
	...
	\begin{tabular}{c c c}
		...
		{\colorbody \textbf{\EUR{1283,00}}} 
		\\
		
		
		\rowcolorlight
		{\colorbody \textbf{Differenza}} & {\colorbody -} & 
		{\colorbody \textbf{-\EUR{830,00}}} 
		\\
		\rowcolordark
		{\colorbody \textbf{Totale con costi(\EUR{825,00})}} & & 
		{\colorbody \textbf{-\EUR{5,00}}} 
		\\
...
\subsubsection{Preventivo a finire}
A seguito di un ottima codifica del prodotto eseguita grazie all'impiego di un monte ore maggiore nelle fasi precedenti, sono stati risparmiati \EUR{830,00} ai quali vengono sottratti gli \EUR{825,00} di debito della precedente fase, per un risparmio totale di \EUR{5,00}. Visto la grande percentuale di requisiti desiderabili e facoltativi implementati e la totalità dei requisiti obbligatori, il gruppo si dichiara soddisfatto del consuntivo a finire. Questo anche a seguito di un incontro con la proponente la quale ha accettato di buon grado l'ultima versione presentata.
