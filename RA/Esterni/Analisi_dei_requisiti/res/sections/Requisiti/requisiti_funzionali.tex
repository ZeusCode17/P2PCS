...
\begin{longtable}{ >{\centering}p{0.15\textwidth} >{\centering}p{0.20\textwidth}
	...
	\tabularnewline
	RFF12.1 & Facoltativo & L'utente può modificare l'auto sulla base delle prestazioni. & UC22.1
	\tabularnewline
	RFF12.1.1 & Facoltativo & L'utente può modificare il motore dell'auto di partenza. & UC22.1
	\tabularnewline
	RFF12.1.2 & Facoltativo & L'utente può modificare la centralina dell'auto di partenza. & UC22.1.2
	\tabularnewline
	RFF12.1.3 & Facoltativo & L'utente può modificare la trasmissione dell'auto di partenza. & UC22.1.3
	\tabularnewline
	RFF12.1.4 & Facoltativo & L'utente può modificare le sospensioni dell'auto di partenza. & UC22.1.4
	\tabularnewline
	RFF12.1.5 & Facoltativo & L'utente può modificare le gomme dell'auto di partenza. & UC22.1.5
	\tabularnewline
	RFF12.2 & Facoltativo & L'utente può modificare l'auto sulla base dell'estetica. & UC22.2
	\tabularnewline
	RFF12.2.1 & Facoltativo & L'utente può modificare il colore dell'auto di partenza. & UC22.2.1
	\tabularnewline
	RFF12.2.2 & Facoltativo & L'utente può aggiungere l'adesivo all'auto di partenza. & UC22.2.2
	\tabularnewline
	RFF12.2.3 & Facoltativo & L'utente può modificare i paraurti (anteriori e posteriori) dell'auto di partenza. & UC22.2.3
	\tabularnewline
	RFF12.2.4 & Facoltativo & L'utente può modificare i fari (anteriori e posteriori) dell'auto di partenza. & UC22.2.4
	\tabularnewline
	RFF12.2.5 & Facoltativo & L'utente può modificare gli scarichi dell'auto di partenza. & UC22.2.5
	\tabularnewline
	RFF12.2.6 & Facoltativo & L'utente può modificare i cerchioni dell'auto di partenza. & UC22.2.6
	\tabularnewline
	RFF12.2.7 & Facoltativo & L'utente può aggiungere l'alettone all'auto di partenza. & UC22.2.7
	\tabularnewline
