...
\input{res/sections/UC/UC1-5-GuidaRegistrazione.tex}
\input{res/sections/UC/UC6-9-LoginLogout.tex}
\input{res/sections/UC/UC10-Home.tex}
\input{res/sections/UC/UC11-Gestione-veicoli.tex}
\input{res/sections/UC/UC12-Gestione-prenotazione.tex}
\newpage
\input{res/sections/UC/UC13-Effettua-prenotazione.tex}
\input{res/sections/UC/UC14-StoricoPrenotazioni.tex}
\newpage
\input{res/sections/UC/UC15-16-GestioneProfilo.tex}
\input{res/sections/UC/UC17-18-ProgressBar.tex}
\input{res/sections/UC/UC19-Gioca.tex}
\input{res/sections/UC/UC20-21-Milestone-unlock.tex}
\input{res/sections/UC/UC22-23-LuckySpin.tex}
\input{res/sections/UC/UC24-Leaderboard.tex}
\input{res/sections/UC/UC25-CodiceAmico.tex}
\input{res/sections/UC/UC26-27DailyReward.tex}
\input{res/sections/UC/UC28-29GarageVeicolo.tex}