	...
	\begin{itemize}
		\item \textbf{Norme di Progetto}: 
			\begin{itemize}
				...
				\item gli \textit{Amministratori} si sono impegnati a migliorare la normazione delle attività di processo adottate.
			\end{itemize}
		\item \textbf{Analisi dei Requisiti}:
			\begin{itemize}
...
\subparagraph{Test di sistema} {\color{white}.}
