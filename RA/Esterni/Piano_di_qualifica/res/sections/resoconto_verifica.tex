...
\end{itemize}
	...
	\begin{longtable}{ >{\centering}p{0.25\textwidth} >{\centering}p{0.10\textwidth}
		...
		Cost Variance & \euro{} & +140,00 & S. & $ \geq 0$
		\tabularnewline
...
\end{itemize}
	...
	\begin{longtable}{ >{\centering}p{0.25\textwidth} >{\centering}p{0.10\textwidth}
		...
		Cost Variance & \euro{} & -965,00 & N.S. & $ \geq 0$
		\tabularnewline
...
\end{itemize}
	...
	\begin{longtable}{ >{\centering}p{0.25\textwidth} >{\centering}p{0.10\textwidth}
		...
		Actual Cost & \euro{} & 1.278,00 & S & $0 \leq AC \leq 2.113,00 $
		\tabularnewline
		...
		Cost Variance & \euro{} & +825,00 & S & $ \geq 0$
		\tabularnewline
		
		Schedule Variance & \euro{} & +5 & S & $ \geq 0$
		\tabularnewline
