...
\begin{itemize}
		...
		\begin{itemize}
			...
			\item \textbf{Soluzione:} il gruppo ha contattato il proprietario della libreria nella speranza di ottenere la versione precedente. Non ricevendo risposta il gruppo ha deciso di abbandonare questa tecnica di gamefication rimpiazzandola con il mini-gioco garage.
		\end{itemize}
\end{itemize}