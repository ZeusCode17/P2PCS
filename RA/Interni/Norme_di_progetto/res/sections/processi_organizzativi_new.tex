\section{Processi organizzativi}
	...
	\subsection{Gestione organizzativa}
		...
		\begin{itemize}
			\item il processo organizzativo deve essere avviato con l'apprendimento dei requisiti del processo da intramprendere;
			\item una volta stabiliti i requisiti, l'Amministratore deve stabilire la fattibilità del processo verificando che le risorse (umane, materiali, tecnologiche, ambientali) richieste per l'esecuzione e gestione del processo siano disponibili, adeguate, e appropriate e che gli scali temporali per il completamento siano conseguibili.
			\item Se necessario, per accordo tra le stakeholders\glo, i requisiti del processo possono essere modificati in questo punto per garantire il criterio di completamento.
		\end{itemize}
		\paragraph{Pianificazione}
		Questa attività consiste nei seguenti compiti:
		\begin{itemize}
			\item l'amministratore deve preparare i piani di esecuzione del processo. I piani associati all'esecuzione del processo devono contenere descrizioni delle attività e compiti associati e  identificazione dei prodotti software che saranno forniti;
			\item la pianificazione deve includere, ma non ne è limitata, dai seguenti:
			\begin{itemize}
				\item pianificazione per l'esecuzione temporale dei compiti;
				\item stima degli sforzi;
				\item risorse adeguate necessarie per l'esecuzione dei task;
		...
		\begin{itemize}
			\item l'amministratore deve avviare l'implementazione dei piani stabiliti per soddisfare gli obiettivi e criteri scelti, ed esercitare il controllo del processo.
			\item l'amministratore deve monitorare l'esecuzione del processo, fornendo:
			\begin{itemize}
				\item report interni del progresso del processo;
				\item report esterno per l'acquirente come definito nel contratto.
			\end{itemize}
			\item l'amministratore deve investigare, analizzare e risolvere problemi scoperti durante l'esecuzione del processo. La risoluzione dei problemi può comportare cambiamenti alla pianificazione. E' responsabilità dell'amministratore assicurare che l'impatto dei cambiamenti sia determinato, controllato e monitorato. Problemi nella loro risoluzione devono essere documentato.
		\end{itemize}
		\paragraph{Revisione e valutazione}
		Questa attività consiste dei seguenti compiti:
		\begin{itemize}
			\item l'amministratore deve assicurarsi che il prodotto software e la pianificazione siano valutati per assicurare il soddisfacimento dei requisiti.
			\item l'amministratore deve fornire i risultati della valutazione del software, attività e compiti completati durante l'esecuzione del processo;
		\end{itemize}
		\paragraph{Conclusione}
		Questa attività consiste dei seguenti compiti:
		\begin{itemize}
			\item quando tutti i prodotti software, attività e compiti sono completati, l'amministratore deve determinare se il processo è stato completato tenendo in conto i criteri specificati nel contratto o come parte del processo organizzativo.
			\item l'amministratore deve controllare e documentare il prodotto software, le attività e i compiti assegnati per il completamento. Questi risultati e documenti deve essere archiviati in un ambiente adatto come specificato nel contratto. 
		\end{itemize}
