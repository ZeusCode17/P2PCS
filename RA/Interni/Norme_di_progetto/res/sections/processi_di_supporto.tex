...
\subsection{Documentazione}
	...
	\end{itemize}
		\paragraph{Creazione della prima pagina} \mbox{}\\ \mbox{}\\
		...
		\end{itemize}
		\paragraph{Aggiornamento del registro delle modifiche} \mbox{}\\ \mbox{}\\
	...
	\subsubsection{Norme tipografiche}
		...
		\begin{itemize}
			...
			\item se nel \textit{Glossario v4.0.0} un termine presenta una descrizione che utilizza termini da glossario, è necessario trattare questi termini come tali, segnando la \textbf{G} a pedice e aggiungendoli al documento con la relativa descrizione;
	...
	\subparagraph{Repository} \mbox{}\\ \mbox{}\\
...
\subsection{Validazione}
	...
	\begin{itemize}
		...
		\item le attività di validazione richieste sono state eseguite;
		\item i problemi sono stati identificati e registrati;
		\item le conformità del prodotto finito;
		\item i risultati delle attività di validazione vengono resi disponibili alle parti coinvolte.
	\end{itemize}
	\end{comment}
	\subsubsection{Attività}
