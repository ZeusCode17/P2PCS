...
Al fine di evitare ambiguità e facilitare la comprensione dei documenti formali viene incluso il Glossario v4.0.0, in cui saranno presenti acronimi, abbreviazioni e termini tecnici. Ogni termine presente nel glossario sarà marcato con una G a pedice.
...
\begin{itemize}
	...
	\begin{itemize}
	\item §2.1 Processo di fornitura;
	\item §2.2 Processo di sviluppo;
	\item §3.1 Documentazione;
	\item §3.2 Gestione della documentazione;
	\item §3.3 Verifica;
	\item §3.4 Validazione
	\item §4.1 Gestione organizzativa; 	
	\end{itemize}
