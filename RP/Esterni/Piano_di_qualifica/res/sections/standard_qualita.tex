\section{Standard di qualità}
	...
	Questo standard è diviso in quattro parti che vengono riportate di seguito.
		...
		Definisce metriche applicabili al codice sorgente non eseguibile che ne misurano eventuali problemi che ne possono minare la qualità ancora prima di mandare il software in esecuzione. Viene rilevata tramite  analisi statica. Idealmente, la qualità interna determina la qualità esterna.
		\subsubsection{Metriche per la qualità esterna}
		Definisce metriche applicabili al software in esecuzione che ne misurano i comportamenti tramite test in funzione degli obiettivi stabiliti. Viene rilevata tramite analisi dinamica. Idealmente, la qualità esterna determina la qualità in uso.
