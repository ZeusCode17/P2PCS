...
\end{itemize}
	...
	%	& \textbf{\color{white}Fonti} 
	 ...
	 \texttt{TS18}	& RFF16 &	Verificare che il sistema permetta all'utente autenticato all'utente autenticato di poter accedere al Minigioco del garage in cui potrà visualizzare le statistiche e apportare nuove modifiche ad un'auto base di partenza. &	NI	\tabularnewline
