...
Per valutare la qualità del prodotto il gruppo ha deciso di far riferimento allo standard ISO/IEC 9126\glosp{} che definisce le caratteristiche di cui tener conto per produrre un prodotto di buona qualità. Le caratteristiche sono descritte attraverso dei parametri, che ne quantificano il grado di raggiungimento. Di seguito vengono citate le voci che il gruppo ha ritenuto rilevanti nel contesto del progetto.
	...
	Capacità del prodotto di fornire funzioni che soddisfino i requisiti espliciti ed impliciti dichiarati dell'Analisi dei Requisiti.
		...
		\begin{itemize}
			\item \textbf{Adeguatezza}: fornire un insieme appropriato di funzioni per le attività specificate;
			\item \textbf{Accuratezza}: fornire i risultati o gli effetti desiderati con il grado di precisione richiesto;
	...
	Capacità del prodotto di mantenere un certo livello di prestazioni quando utilizzato nelle condizioni specificate.
		...
		\end{itemize}
		\subsubsection{Metriche}
			\paragraph{Densità dei guasto nei casi di test}
