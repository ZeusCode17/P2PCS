...
\end{comment}\begin{figure}[H]
	\includegraphics[width=9cm]{res/images/UseCase.png}
	\centering
	\caption{Use Cases che interessano gli utenti}
\end{figure}
\end{comment}
\input{res/sections/UC/UC1-3-GuidaRegistrazione.tex}
\input{res/sections/UC/UC4-7-LoginLogout.tex}
\input{res/sections/UC/UC8-Gestione-veicoli.tex}
\input{res/sections/UC/UC9-Gestione-prenotazione.tex}
\input{res/sections/UC/UC11-StoricoPrenotazioni.tex}
\input{res/sections/UC/UC12-ModificaDati.tex}
