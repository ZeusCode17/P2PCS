...
\begin{itemize}
	...
	\item \textbf{Descrizione}: il proprietario del veicolo conferma o annulla la prenotazione ricevuta;
	\item \textbf{Scenario principale}: l'utente si trova all'interno della pagina di visualizzazione dei dettagli della prenotazione precedentemente selezionata. Attraverso gli appositi campi l'utente potrà specificare:
	\begin{itemize}
	...
	\item \textbf{Post-condizione}: l'utente ha confermato o annullato correttamente la prenotazione selezionata.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Precondizione}: i campi dati necessari per la conferma della prenotazione sono compilabili. È presente il pulsante per la conferma della prenotazione;
