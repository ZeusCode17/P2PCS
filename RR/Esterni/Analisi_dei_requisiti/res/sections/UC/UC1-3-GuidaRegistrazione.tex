...
%QUI VA INSERITO CASO D'USO UC2 ERRORE REGISTRAZIONE

\subsubsection{UC3 - Visualizzazione activity introduttiva}
\begin{itemize}
...
\end{itemize}
\begin{figure}[h]
	\includegraphics[width=7cm]{res/images/UC1Introduttiva.png}
	\centering
	\caption{UC1 - Visualizzazione activity introduttiva}
\end{figure}
