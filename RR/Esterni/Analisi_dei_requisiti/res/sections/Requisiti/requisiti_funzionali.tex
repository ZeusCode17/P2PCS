...
\begin{longtable}{ >{\centering}p{0.15\textwidth} >{\centering}p{0.20\textwidth}
	...
	RFO7.1	&	Obbligatorio	&	L'utente può filtrare i veicoli secondo l'inserimento di una data.	&	Interno\\ UC12.1	\tabularnewline
	RFO7.2	&	Obbligatorio	&	L'utente può filtrare i veicoli secondo l'inserimento di una fascia oraria.	&	Interno\\ UC12.2	\tabularnewline
	RFO7.3	&	Obbligatorio	&	L'utente può filtrare i veicoli secondo un raggio in km.	&	Interno\\ UC12.3	\tabularnewline
	...
	RFO9.1	&	Obbligatorio	&	L'utente deve inserire l'immagine della patente fronte e retro.	&	Capitolato \\ UC14.1.1	\tabularnewline
	RFO9.1	&	Obbligatorio	&	L'utente deve inserire il numero della patente.	&	Capitolato \\ UC14.1.2	\tabularnewline
	RFO9.1	&	Obbligatorio	&	L'utente deve inserire la data di rilascio della patente.	&	Capitolato \\ UC14.1.3	\tabularnewline
	RFO9.1	&	Obbligatorio	&	L'utente deve inserire la data di scadenza della patente.	&	Capitolato \\ UC14.1.4	\tabularnewline
	...
	RFF11 &	Obbligatorio &	L'utente possiede livelli d'esperienza e visualizza una tabella con i premi per ogni livello d'esperienza. & UC18 \tabularnewline
	RFF11.1	& Obbligatorio & L'utente ritira i premi per il raggiungimento di un nuovo livello d'esperienza. & UC19 \tabularnewline
	...
	\tabularnewline
	RFF16 & Facoltativo & All'utente è reso disponibile un Minigioco composto da un garage dove è possibile fare modifiche ad un'auto base di partenza. & UC26 
	\tabularnewline
	...
	\tabularnewline
	RFF16.3 & Facoltativo & L'utente può annullare tutte le modifiche apportate all'auto. & UC27
	\tabularnewline
