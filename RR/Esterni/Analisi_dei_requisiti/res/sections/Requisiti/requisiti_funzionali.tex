...
\begin{longtable}{ >{\centering}p{0.15\textwidth} >{\centering}p{0.20\textwidth}
	...
	RFO9.1.1	&	Obbligatorio	&	L'utente deve inserire l'immagine della patente fronte e retro.	&	Capitolato \\ UC14.1.1	\tabularnewline
	RFO9.1.2	&	Obbligatorio	&	L'utente deve inserire il numero della patente.	&	Capitolato \\ UC14.1.2	\tabularnewline
	RFO9.1.3	&	Obbligatorio	&	L'utente deve inserire la data di rilascio della patente.	&	Capitolato \\ UC14.1.3	\tabularnewline
	RFO9.1.4	&	Obbligatorio	&	L'utente deve inserire la data di scadenza della patente.	&	Capitolato \\ UC14.1.4	\tabularnewline
