...
\begin{longtable}{ >{\centering}p{0.10\textwidth} >{\centering}p{0.25\textwidth}
	...
	RQO3	&	Obbligatorio	&		Devono essere rispettati i criteri definiti nel documento Norme di Progetto	&	Interno	\tabularnewline
	RQO4	& Obbligatorio	& 	Devono essere rispettati i processi descritti nel documento \textit{Piano di Qualifica} &	Interno \tabularnewline
