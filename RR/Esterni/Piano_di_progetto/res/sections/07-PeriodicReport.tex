...
\begin{itemize}
	\item \textbf{Amministratori:} la ricerca e configurazione dei software atti alla produzione e alla gestione del progetto ha richiesto più tempo del previsto, in particolare la creazione dei template \LaTeX\space e la configurazione di PragmaDb\glosp;\
