...
\section{Riepilogo delle decisioni}
	...
	\begin{longtable}{ >{\centering}p{0.20\textwidth} >{}p{0.70\textwidth}}
		...
		\tabularnewline 
		\endfirsthead
		VE\_1.1 & Scelto linguaggio di sviluppo Kotlin\glosp per applicazione Android\glo.
		
		\tabularnewline 
		VE\_1.2 & Scelto utilizzo della piattaforma Movens\glo.
		
		\tabularnewline 
		VE\_1.3 & Scelta dei core-drive\glosp Octalisys\glosp per implementare una strategia di gamification\glo.
	
		\tabularnewline 
		VE\_1.4 & Scelto come strutturare il codice di programmazione e quindi inserito come punto nelle \textit{Norme di Progetto}.
		
		\tabularnewline 
		VE\_1.5 & Definito e discusso i requisiti obbligatori ed opzionali richiesti.
		
		\tabularnewline 
		VE\_1.6 & Riassunto della conferenza col gruppo e organizzato incontro.
