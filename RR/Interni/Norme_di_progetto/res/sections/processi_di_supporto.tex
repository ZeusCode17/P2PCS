...
\subsection{Documentazione}
	...
	\subsubsection{Scopo}
	Lo scopo ultimo della configurazione è di creare coiesione tra software e documenti. Ogni file è caratterizzato da un identificativo univoco, si trova in uno stato di versionamento ed è modificato secondo determinate procedure.
	...
	\begin{itemize}
		\item \textbf{locale}: repository locale clonata sul pc di ogni mebro del gruppo nella quale vengono eseguite le modifiche.
