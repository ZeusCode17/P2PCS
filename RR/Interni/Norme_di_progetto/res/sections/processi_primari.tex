...
\subsection{Sviluppo}
	...
	\subsubsection{Attività}
		...
		\paragraph{Codifica} \mbox{}\\ \mbox{}\\
			...
			\end{itemize}
			Come supporto alla scrittura del codice scritto in Kotlin si consiglia di seguire la documentazione fornita da \textit{JetBrains}\glosp e \textit{Android}\glo. \newline \newline
