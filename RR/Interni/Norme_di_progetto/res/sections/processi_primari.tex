...
\subsection{Sviluppo}
	...
	\subsubsection{Attività}
		...
		\paragraph{Progettazione} \mbox{}\\ \mbox{}\\
			...
			\begin{itemize}
				...
				\item \textbf{Design pattern\glo}: devono essere descritti i design pattern utilizzati per realizzare l'architettura. Ogni design pattern deve essere accompagnato da una descrizione ed un diagramma, che ne esponga il significato e la struttura;
		...
		\paragraph{Codifica} \mbox{}\\ \mbox{}\\
			...
			\end{itemize}
			Come supporto alla programmazione del codice scritto in Kotlin si consiglia di seguire la documentazione fornita da \textit{JetBrains}\glosp e \textit{Android}\glo. \newline \newline
	...
	Di seguito sono elencati gli strumenti utilizzati dal gruppo durante il progetto per il processo di sviluppo.	
		...
		Android Studio è un ambiente di sviluppo integrato per lo sviluppo per la piattaforma Android. Il linguaggio utilizzato in questo ambiente è Kotlin\glo. 
		 \newline
