...
Il prodotto finale utilizza un pattern Producer-Consumer\glosp che raccoglie le varie segnalzioni mandate dalle applicazioni e le indirizza attraverso i canali scelti dall’utilizzatore.L’azienda propone una soluzione a quattro componenti, così strutturate:
\begin{itemize}
	\item \textbf{Producers}: raccolgono le segnalazioni provenienti dalle varie applicazioni e le pubblicano, sotto forma di messaggio, all’interno dello specifico topic\glosp;
	\item \textbf{Broker}: strumento che istanzia e gestisce i topic\glosp;
	\item \textbf{Consumers}: componenti che hanno il compito di abbonarsi ai topic\glosp adeguati, recuperarne i messaggi ed inviarli verso i destinatari finali. I componenti richiesti hanno come finalità l’invio di segnalazioni attraverso Telegram, Slack e Email;
...
\begin{itemize}
	\item \textbf{Java}, \textbf{Python}\glosp, \textbf{Node.js}\glosp: alternative di linguaggi per lo sviluppo dell'applicativo suggerite dal proponente; 
	\item\textbf{Apache Kafka}\glosp: software open-source per la gestione delle operazioni tra i vari client, da utilizzare come Broker;
