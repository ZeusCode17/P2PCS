...
\begin{longtable}{ >{\centering}p{0.15\textwidth} >{\centering}p{0.20\textwidth}
	...
	RFO5.2.1	&	Obbligatorio	& L'utente può aggiungere la disponibilità del proprio veicolo.	&	Capitolato \\ UC10.3	\tabularnewline
	RFO5.2.1.1	&	Obbligatorio	& L'utente può decidere se rendere disponibile il veicolo in ripetizione.	&	Capitolato \\ UC10.3.1	\tabularnewline
	RFO5.2.2	&	Obbligatorio	& L'utente può rimuove il veicolo.	&	Capitolato \\ UC10.4	\tabularnewline
