...
\end{itemize}
A questo punto il back-end sarà attivo. Ora è necessario collegarlo all'applicazione tramite Android Studio: alla voce "Tools" selezionare Firebase, aprire la voce Authentication e tramite l'apposito pulsante connettere l'app a Firebase.
