...
\end{itemize}
	...
	%	& \textbf{\color{white}Fonti} 
		...
		TA2	& RFD1 &	L'utente deve poter visualizzare la guida introduttiva. All'utente viene chiesto di:
		 ...
		 Per ogni prenotazione attiva presente nella lista l'utente deve poter visualizzare i dettagli riassuntivi (maraca, modello, stato della prenotazione, data, fascia oraria e foto del veicolo) ed eseguire operazioni di gestione su di esse (visualizzazione dettaglio). All'utente viene chiesto di:
		 \begin{itemize}
