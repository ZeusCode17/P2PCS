...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	Durante l'attività di test, sono emersi dei problemi di integrazione tra le componenti che sono stati prontamente risolti dai \textit{Programmatori}. 
	\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{itemize}
	...
	\begin{longtable}{ >{\centering}p{0.25\textwidth} >{\centering}p{0.10\textwidth}
		...
		Requisiti obbligatori soddisfatti & \% & TODO & TODO & 100
		\tabularnewline 
		
		Coupling Between Object classes & V & TODO & TODO & $0 \leq CBO \leq 6$
		\tabularnewline
		...
		Percentuale di metriche soddisfatte & \% & TODO & S & 100
		\tabularnewline
	...
	\begin{longtable}{ >{\centering}p{0.40\textwidth} >{\centering}p{0.25\textwidth}
		...
		\tabularnewline 
		\textit{Piano di Progetto v2.0.0} & 55,02 & Superato
		
		\tabularnewline 
		\textit{Piano di Qualifica v2.0.0} & 58,51 & Superato	
	...
	\begin{longtable}{ >{\centering}p{0.25\textwidth} >{\centering}p{0.10\textwidth}
		...
		Densità dei guasti nei casi di test & \% & TODO & TODO & $ \leq 10$
		\tabularnewline
		
		Risoluzione dei guasti & \% & TODO & TODO & 100
		\tabularnewline
		
		Facilità di utilizzo & V & TODO & TODO & $0 \leq 15 $
		\tabularnewline
		
		Facilità di apprendimento & V & TODO & TODO & $ \leq 5$
		\tabularnewline
		
		Profondità della gerarchia & V & TODO & TODO & $ \leq 7 $
		\tabularnewline
		
		Comprensione delle funzioni & \% & TODO & TODO & $ \geq 95$
		\tabularnewline
		
		Facilità di comprensione & V & TODO & TODO & $ \geq 0.10$
		\tabularnewline
		
		Semplicità delle funzioni & V & TODO & TODO & $\leq 6$
		\tabularnewline
		
		Semplicità delle classi & V & TODO & TODO & $ \leq 15$
		\tabularnewline
		
		SFIN: Structural Fan-in (media) & V & TODO & TODO & $ \geq 0 $
		\tabularnewline
		
		SFOUT: Structural Fan-out (media) & V & TODO & TODO & $ \leq 6$
		\tabularnewline
