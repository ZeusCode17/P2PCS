...
\begin{longtable}{ 
	...
	2.0.5 & 2019-06-09 & Andrea Pigatto & \textit{Verificatore}
	& Revisione del documento.			
	\tabularnewline
	
	2.0.4 & 2019-06-05 & Riccardo Basso & \textit{Amministratori}
	& Rivista i test di accettazione e test di sistema.
	\tabularnewline	
	
	2.0.3 & 2019-05-31 & Riccardo Basso & \textit{Amministratori}
	& Stesura dei test di integrità.
	\tabularnewline
	
	2.0.2 & 2019-05-26 & Diba Meysamiazad & \textit{Amministratori}
	& Stesura dei test di unità.
	\tabularnewline	
	
	2.0.1 & 2019-05-25 & Riccardo Dario & \textit{Amministratore}
