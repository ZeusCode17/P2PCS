...
\subsection{Sviluppo}
	...
	\subsubsection{Attività}
		\paragraph{Analisi dei Requisiti} \mbox{}\\ \mbox{}\\
			...
			\begin{itemize}
			\item il design architetturale del software è sviluppato e standardizzato in modo da descrivere le i componenti software che implementano i requisiti;
			\item le interfacce interne ed esterno sono definite;
			...
			Per ogni componente software questa attività consiste dei seguenti compiti, svolti dal programmatore:
			\newline \newline
			\begin{itemize}
			\item trasformare i requisiti del software in un' architettura che descrive il suo la sua struttura ad alto livello e ne identifica i suoi componenti. Si deve inoltre assicurare che tutti i requisiti per la parte software siano assegnati alla componente software corrispondente e ulteriormente raffinato per semplificare il desing dettagliato. Tale architettura va descritta nel \textit{Piano di Progetto};
			...
			\item sviluppare una versione preliminare del manuale utilizzatore;
			...
			\item fattibilità delle operazioni di manutenzione.
			\end{itemize}
			\subparagraph{Technology baseline}\glo: contiene le specifiche della progettazione ad alto livello del prodotto e delle sue componenti, l'elenco dei diagrammi UML\glosp che saranno utilizzati per la realizzazione dell'architettura e i test di verifica;\newline \newline
...
individuati all'interno di ciascun prodotto software.
			...
			\item consistenza e tracciabilità sono stabilite tra il design dettagliato, requisiti e design architetturale.
			\end{itemize}
			\textbf{Attività}\newline \newline
			...
			\item fattibilità delle operazioni di manutenzione.
			\end{itemize}
			\subparagraph{Product baseline}\glo: dettaglia ulteriormente l'attività di progettazione, integrando ciò che è riportato nella Technology baseline. Inoltre definisce i test necessari alla verifica.\newline \newline
