...
\subsection{Sviluppo}
	...
	\subsubsection{Attività}
		\paragraph{Analisi dei requisiti} \mbox{}\\ \mbox{}\\
			...
			\noindent{\textbf{UML}} \newline \newline
			I diagrammi UML\glosp devono essere realizzati usando la versione del linguaggio v2.0. Lo strumento per la creazione dei diagrammi UML che il gruppo utilizzerà per compiere l'analisi dei requisiti è l'applicazione web \textit{Draw.io}. 
